...
from helper_functions_cds_determination import get_fasta_tid, get_cds_genomic_coordinates,\
      ...
      intersect_and_select_greatest_overlap, calculate_50nt_rule
...
def determine_cds(transcript_gtftk_object, transcript_ids_wo_cds, reference_file, reference_sequences_file, gtf_file):
    ...
    if len(transcripts_several_orfs) > 0:
        ...
        .saveas('transcripts_with_several_orfs.bed')
        ...
        transcripts_with_CDS = intersect_and_select_greatest_overlap(transcripts_several_orfs_bed, pc_reference_bed)
    ...
    #print("tid_no_overlap", set(tid_no_overlap))
        ...
        transcripts_with_CDS = transcripts_cds_determined
